...
from utils.constants import (
    NAME_CHARFIELD_LENGTH,
    CODE_CHARFIELD_LENGTH,
    HUGE_CHARFIELD_LENGTH,
    PRICE_DECIMALFIELD_DIGITS_LENGTH,
...
class ProductCharacteristic(BaseModel):
    ...
    characteristic = models.ForeignKey(Characteristic, related_name="product_characteristics", on_delete=models.CASCADE)
